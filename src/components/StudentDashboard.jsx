...
export default function StudentDashboard() {
    ...
    const [currentView, setCurrentView] = useState('dashboard'); // dashboard, enrolledCourses, liveClasses, editProfile, settings
                ...
                <main className="p-6 lg:p-10">
                    ...
                    {currentView === 'dashboard' && (
                        <>
                            {/* Hero Section */}
                            <StudentHero 
                                onShowEnrolledCourses={handleShowEnrolledCourses}
                                onShowLiveClasses={handleShowLiveClasses}
                            />
